...
func TestGenerate(t *testing.T) {
	...
	tests := []struct {
		...
		//	name: "sql from db",
		//	args: args{args: &Args{
		//		DBDsn:   "root:123456@(192.168.209.8:3306)/test",
		//		DBTable: "user",
		//	}},
		//	wantErr: false,
		//},
...
func TestGenerateError(t *testing.T) {
	...
	a = &Args{DBDsn: "root:123456@(192.168.209.8:3306)/test"}
	_, err = Generate(a)
	assert.Error(t, err)

	a = &Args{DBDsn: "root:123456@(192.168.209.8:3306)/test", DBTable: "user"}
	_, err = Generate(a)
	assert.Error(t, err)
