...
// NewJaegerExporter use jaeger collector as exporter, e.g. default url=http://192.168.209.8:14268/api/traces
...
// NewJaegerAgentExporter use jaeger agent as exporter, e.g. host=192.168.209.8 port=6831
