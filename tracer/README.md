...
```go
import "github.com/18721889353/common_pkg/tracer"
...
func initTrace() {
	...
	// exporter, err := tracer.NewJaegerExporter("http://192.168.209.8:14268/api/traces") // output to jaeger, using collector http
