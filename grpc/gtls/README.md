...
```go
import "github.com/18721889353/common_pkg/grpc/gtls"
...
func main() {
	...
	//credentials, err := gtls.GetClientTLSCredentials("192.168.209.8", certfile.Path("/one-way/server.crt"))
	...
	conn, err := grpc.Dial("192.168.209.8:8080", grpc.WithTransportCredentials(credentials))
	if err != nil {
		panic(err)
	}
